...
const MODULES = [
  ...
  },
  {
    ...
    emoji: '🧘',
    title: 'Habits',
    description: 'Daily habits, goals & life tracking',
  ...
  },
  {
    ...
    emoji: '💪',
    title: 'Fitness',
    description: 'Workouts, meals, body & training',
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] dark:bg-gray-950">
      {/* Top bar */}
      <header className="sticky top-0 z-30 bg-[#f5f5f7]/70 dark:bg-gray-950/70 backdrop-blur-xl border-b border-black/5 dark:border-white/5 px-6 py-4 flex items-center justify-between">
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {MODULES.map(m => (
              <Link key={m.href} href={m.href}
                className={`group rounded-3xl p-6 border ${m.border} ${m.bg} hover:shadow-md hover:-translate-y-0.5 active:scale-[0.98] transition-all duration-300 ease-apple flex items-start justify-between`}>
                <div>
