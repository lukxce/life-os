    ...
    <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div>
              ...
              <div className="flex mt-1">
                <NumberInput value={logAmount} onChange={setLogAmount} placeholder="Amount"
                  className="flex-1 border border-gray-300 dark:border-gray-600 rounded-l-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-gray-100" />
                <select value={logCurrency} onChange={e => setLogCurrency(e.target.value)}
                  className="border border-l-0 border-gray-300 dark:border-gray-600 rounded-r-lg px-2 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-gray-100">
                  <option>EUR</option><option>USD</option><option>RSD</option>
                </select>
              </div>
            </div>
      ...
      <div className="space-y-3">
        {filtered.length === 0 ? (
          ...
          <div key={s.id} className={`bg-white/85 dark:bg-gray-900/70 rounded-xl border border-black/10 dark:border-white/10 p-4 ${!s.active ? 'opacity-50' : ''}`}>
