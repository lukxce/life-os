      ...
      {showForm && (
        <div className="bg-surface/90 dark:bg-surface/70 rounded-xl border border-black/10 dark:border-white/10 p-4">
          ...
          <div className="flex gap-3 mt-4">
            <button onClick={submit} className="bg-[rgb(var(--l-green))] text-white px-5 py-2 rounded-lg text-sm font-medium hover:bg-[rgb(var(--l-green))]">{editingId ? 'Update' : 'Save'}</button>
      ...
      <div className="bg-surface/90 dark:bg-surface/70 rounded-xl border border-black/10 dark:border-white/10 overflow-hidden">
        {holdings.length === 0 ? (
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 dark:bg-gray-800 border-b border-black/10 dark:border-white/10">
              <tr>
