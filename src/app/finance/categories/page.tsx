              ...
              <>
                ...
                <div className="flex items-center gap-1 shrink-0">
                  <button onClick={() => setShowSubForm(cat.id)}
                    className="text-xs text-blue-600 hover:text-blue-700 font-medium px-2">+ Sub</button>
            ...
            <div className="px-4 pb-4 border-t border-gray-100 pt-3">
              <div className="flex gap-2">
                ...
                <button onClick={() => addSubcategory(cat)}
                  className="bg-blue-600 text-white px-3 py-1.5 rounded-lg text-sm font-medium">Add</button>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              <button onClick={() => addCategory(type)}
                className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium">Save</button>
