...
function ExpensesContent({ params }: { params: { type: string } }) {
  ...
  return (
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      {/* Filter bar */}
      {showFilters && (
        <div className="bg-surface/90 dark:bg-surface/70 rounded-xl border border-black/10 dark:border-white/10 dark:border-gray-700 dark:border-gray-700 p-4">
      ...
      <div className="md:hidden space-y-3">
        {filteredEntries.length === 0 ? (
          <div className="bg-surface/90 dark:bg-surface/70 rounded-xl border border-black/10 dark:border-white/10 dark:border-gray-700 dark:border-gray-700 p-8 text-center text-gray-400 dark:text-gray-500 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500">
            {entries.length === 0 ? 'No expenses yet' : 'No expenses match your filters'}
          </div>
        ) : filteredEntries.map(e => (
