            ...
            {items.map(item => {
              ...
              return (
                <li key={item.id} className="px-4 py-3 hover:bg-gray-50 flex items-center justify-between gap-3">
                  ...
                  {item.sufUrl ? <a href={item.sufUrl} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-600 p-2 rounded hover:bg-blue-50 shrink-0" title="View receipt"><FileText size={16} /></a> : null}
                </li>
              )
            })}
          </ul>
