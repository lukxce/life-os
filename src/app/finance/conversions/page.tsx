...
export default function ConversionsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {showForm && (
        <div className="bg-white/85 dark:bg-gray-900/70 rounded-xl border border-black/10 dark:border-white/10 dark:border-gray-700 p-4 md:p-6">
      ...
      {/* Desktop table */}
      <div className="hidden md:block bg-white/85 dark:bg-gray-900/70 rounded-xl border border-black/10 dark:border-white/10 dark:border-gray-700 overflow-hidden">
      ...
      <div className="md:hidden space-y-3">
        {entries.length === 0 ? (
          <div className="bg-white/85 dark:bg-gray-900/70 rounded-xl border border-black/10 dark:border-white/10 dark:border-gray-700 p-8 text-center text-gray-400 dark:text-gray-500">No conversions yet</div>
        ) : entries.map(e => (
          <div key={e.id} className="bg-white/85 dark:bg-gray-900/70 rounded-xl border border-black/10 dark:border-white/10 dark:border-gray-700 p-4">
