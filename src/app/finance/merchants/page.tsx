                    ...
                    {editingPib === m.pib ? (
                      <div className="flex items-center gap-1" onClick={e => e.stopPropagation()}>
                        <input
                          ...
                          className="border border-blue-400 rounded px-2 py-0.5 text-sm w-40 focus:outline-none focus:ring-1 focus:ring-[rgb(var(--l-green))] dark:bg-gray-800 dark:text-gray-100"
                        />
