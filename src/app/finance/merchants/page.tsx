                    ...
                    {editingPib === m.pib ? (
                      <div className="flex items-center gap-1" onClick={e => e.stopPropagation()}>
                        <input
                          ...
                          className="border border-ldg-ink/10 rounded px-2 py-0.5 text-sm w-40 focus:outline-none focus:ring-1 focus:ring-[rgb(var(--l-green))] dark:bg-gray-800 dark:text-gray-100"
                        />
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        {m.pib && (
                          <button
                            ...
                            className="opacity-0 group-hover:opacity-100 text-gray-400 hover:text-ldg-green transition-opacity p-0.5"
                          >
                            <Pencil size={12} />
                          </button>
                        )}
