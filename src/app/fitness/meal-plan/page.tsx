  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-green-50 dark:bg-green-950/40 border border-green-200 dark:border-green-900 rounded-2xl px-5 py-3 flex items-center gap-4">
        <Flame size={18} className="text-green-600 shrink-0" />
        <div>
          <p className="text-sm font-semibold text-green-800 dark:text-green-300">Target: 2,100 kcal · 140–160g protein</p>
          <p className="text-xs text-green-600 dark:text-green-500">Eating window 12:00 – 20:00 · 16:8 IF</p>
        </div>
      </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex gap-2">
                            <button onClick={saveEdit} disabled={saving}
                              className="flex items-center gap-1 bg-green-600 text-white px-3 py-1.5 rounded-xl text-xs font-semibold hover:bg-green-700 disabled:opacity-50 transition-colors">
                              <Check size={12} /> Save
                            </button>
