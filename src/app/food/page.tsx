...
export default function FoodMapPage() {
  ...
  const defaultCenter = { lat: 43.32, lng: 21.9 }
  ...
  return (
    <div className="relative w-full h-full">
              ...
              <div className="flex items-start justify-between gap-3 mb-3">
                <div className="min-w-0">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    ...
                    {selected.priceRange && (
                      <span className="text-xs text-gray-400 font-medium">{PRICE_LABEL[selected.priceRange]}</span>
                    )}
                  </div>
              ...
              <div className="space-y-1.5 text-sm mb-4">
                ...
                {selected.mustOrder && (
                  <p className="text-gray-600 dark:text-gray-300">
                    ⭐ <span className="font-medium">{selected.mustOrder}</span>
                  </p>
                )}
      ...
      {/* Add FAB (shown when no detail sheet) */}
      {!selected && (
