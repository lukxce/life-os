  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        {/* Weekly: weight + waist */}
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-black/5 dark:border-white/5 divide-y divide-black/5 dark:divide-white/5 overflow-hidden mb-3">
      ...
      {items.length === 0 ? (
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-black/5 dark:border-white/5 p-6 text-center text-gray-400">
      ...
      {scoreData && scoreData.lastWeek.total > 0 && (
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-black/5 dark:border-white/5 p-4 flex items-center justify-between">
          <div>
