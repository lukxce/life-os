      ...
      {data.habitStats.length === 0 ? (
        ...
        <>
          ...
          <section>
            ...
            <div className="bg-surface/90 dark:bg-surface/70 border border-black/5 dark:border-white/5 rounded-2xl divide-y divide-black/5 dark:divide-white/5">
              {sortedByRate.map(h => (
          ...
          {data.trend.length > 0 && (() => {
            ...
            return (
              <section>
                ...
                <div className="bg-surface/90 dark:bg-surface/70 border border-black/5 dark:border-white/5 rounded-2xl p-4 space-y-4">
          ...
          {data.trend.length > 1 && (
            <section>
              ...
              <div className="bg-surface/90 dark:bg-surface/70 border border-black/5 dark:border-white/5 rounded-2xl p-4">
