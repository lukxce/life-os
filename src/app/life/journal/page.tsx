...
import { Plus, Trash2, ChevronDown, BookOpen, Settings2 } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => setManagingQuestions(!managingQuestions)} className={cn('p-2.5 rounded-xl transition-colors', managingQuestions ? 'bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600' : 'bg-gray-100 dark:bg-gray-800 text-gray-500')}>
          <Settings2 size={18} />
        </button>
      </div>
